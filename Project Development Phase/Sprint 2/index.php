...
<html lang="en">
    <head>
        ...
        <title>Doctor E- Appointment </title>
        <!-- Bootstrap -->
    ...
    <body>
        ...
        <section id="content-1-9" class="content-1-9 content-block">
            <div class="container">
                <div class="underlined-title">
                    <h1>Virology Specialist</h1>
                    <hr>
                    <h2>Infectious Diseases,Microbiology and Virology</h2>
                </div>
                <div class="row">
                    <div class="col-md-4 col-sm-12 col-xs-12 pad25">
                        ...
                        <div class="col-xs-10">
                            <h4>Speciality Lab</h4>
                            <p>Clinical Bio-chemistry,Molecular Biology,Hemotology,Immunoassay & Serology,Infectious Disease</p>
                      </div>
                    </div>
                    <div class="col-md-4 col-sm-12 col-xs-12 pad25">
                        <div class="col-xs-2">
                        ...
                        <div class="col-xs-10">
                            ...
                            <p>Use our convenient patient portal to schedule an Appointment.</p>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-12 col-xs-12 pad25">
                        <div class="col-xs-2">
        ...
        <div class="copyright-bar bg-black">
            <div class="container">
                <p class="pull-left small">©Annai Itans <a>Get More Covid related informations </a></p>
